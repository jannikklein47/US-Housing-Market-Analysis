...
def get_zip_demographics(zip_code):
    ...
    result = {
        ...
        'median_rent': calculate_combined_median(res.monthly_rent_including_utilities_1_b, res.monthly_rent_including_utilities_2_b, res.monthly_rent_including_utilities_3plus_b),
